...
<head>
  ...
  <link rel="stylesheet" href="./static/css/rolunk.css" />
...
<body>
  <div id="main-container">
    ...
    <div class="hero__main" id="hero__main">
      <div class="hero__content">
        <h1 class="hero__title">Ha takartó cég, akkor Pásztor General Taki!</h1>
        <a href="./rolunk.php" class="hero__button">Vegye fel velünk a kapcsolatot!</a>
      </div>
    </div>
    <div class="main__wrapper" id="main__wrapper">
      <div class="main__first-content">
        <div class="logo">
          <img class="logo-img" src="./static/images/logo.png" alt="Pásztor General Taki - logo">
        </div>
        <div class="content">
  ...
  <script src="static/js/rolunk.js"></script>
</body>
